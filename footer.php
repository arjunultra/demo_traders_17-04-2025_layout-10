<footer class="fireworks-footer py-5">
    <div class="container">
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-6">
                        ...
                        <ul class="footer-hours list-unstyled">
                            ...
                            <li class="d-flex align-items-baseline">
                                <div class="mr-2"><i class="bi bi-calendar-event"></i></div>
                                <p class="mb-0">
                                    Festival Days:
                                    Open Full Day
                                </p>
            ...
            <div class="col-12 col-lg-3 text-center text-lg-left">
                ...
                <ul class="footer-contact list-unstyled">
                    ...
                    <li class="d-flex align-items-baseline">
                        <div><i class="bi bi-telephone-fill"></div></i>
        ...
        <div class="text-center pt-4 mt-4 border-top">
            <p class="small mb-2 text-muted">&copy; 2025 Demo Traders. All Rights Reserved.</p>
